...
export default function SettingsPage() {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      // Reauthenticate before changing password (Firebase requirement)
      ...
      else if (err?.code === "auth/requires-recent-login") message = "Please log out and log back in before changing your password.";
      ...
      >
        ...
        <ThemedView style={responsiveStyles.card}>
          ...
          <TouchableOpacity
            ...
            style={[globalStyles.button1, { marginBottom: 12 }]}
          >
            <ThemedText style={globalStyles.actionText2}>Update Password</ThemedText>
          </TouchableOpacity>
          <TextInput
            style={[responsiveStyles.input, globalStyles.baseText]}
